...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkStypeRole_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkStypeRole_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkStypeRole_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkStypeRole_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_UE53x_CPP_Plugins_StypeLiveLink53x_Source_StypeLiveLink_Public_StypeRole_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE53x_CPP_Plugins_StypeLiveLink53x_Source_StypeLiveLink_Public_StypeRole_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkStypeRole, ULiveLinkStypeRole::StaticClass, TEXT("ULiveLinkStypeRole"), &Z_Registration_Info_UClass_ULiveLinkStypeRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkStypeRole), 1121430757U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE53x_CPP_Plugins_StypeLiveLink53x_Source_StypeLiveLink_Public_StypeRole_h_1579632719(TEXT("/Script/StypeLiveLink"),
		Z_CompiledInDeferFile_FID_UE53x_CPP_Plugins_StypeLiveLink53x_Source_StypeLiveLink_Public_StypeRole_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE53x_CPP_Plugins_StypeLiveLink53x_Source_StypeLiveLink_Public_StypeRole_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
