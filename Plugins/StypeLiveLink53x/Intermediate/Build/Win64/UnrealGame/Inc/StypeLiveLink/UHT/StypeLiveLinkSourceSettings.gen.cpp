...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UStypeLiveLinkSourceSettings_Statics::NewProp_DefaultFrameRate = { "DefaultFrameRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UStypeLiveLinkSourceSettings, DefaultFrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UClass_UStypeLiveLinkSourceSettings_Statics::NewProp_DefaultFrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStypeLiveLinkSourceSettings_Statics::NewProp_DefaultFrameRate_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UStypeLiveLinkSourceSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UStypeLiveLinkSourceSettings_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UStypeLiveLinkSourceSettings_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_FreeLiveLinkForStypeHFprotocol_Source_StypeLiveLink_Public_StypeLiveLinkSourceSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_FreeLiveLinkForStypeHFprotocol_Source_StypeLiveLink_Public_StypeLiveLinkSourceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStypeLiveLinkSourceSettings, UStypeLiveLinkSourceSettings::StaticClass, TEXT("UStypeLiveLinkSourceSettings"), &Z_Registration_Info_UClass_UStypeLiveLinkSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStypeLiveLinkSourceSettings), 3865599769U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_FreeLiveLinkForStypeHFprotocol_Source_StypeLiveLink_Public_StypeLiveLinkSourceSettings_h_3447522724(TEXT("/Script/StypeLiveLink"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_FreeLiveLinkForStypeHFprotocol_Source_StypeLiveLink_Public_StypeLiveLinkSourceSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_FreeLiveLinkForStypeHFprotocol_Source_StypeLiveLink_Public_StypeLiveLinkSourceSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
